...
import BannerLedApp.LedAnimation.Swing.LedScreenPlotter;
import BannerLedCore.BannerLeds;
import BannerLedCore.FileMananger.FileMananger;

import java.io.*;
import javax.swing.*;
import List.SimpleList.Random.RandomList;
import java.awt.*;
 ...
 * @author OmarR
 */
public class bnnrldPlayer extends javax.swing.JPanel {

    /**
     * Creates new form bnnrldPlayer
     */
    public bnnrldPlayer() {
        initComponents();
    }
    
    public bnnrldPlayer(JFrame frameParent) {
        this.frameParent = frameParent;
        initComponents();
    }

    public String titleApp = "Nueva Pestaña";
    
    private JFrame frameParent;
    private BannerLeds tabla;
    private LedScreenPlotter graficador;
    ...
    FileMananger filemannger = new FileMananger();
    ...
    private void initComponents() {
        ...
        jButton_Info.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8/info.png"))); // NOI18N
        ...
        jButton_Editar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8/editar.png"))); // NOI18N
        ...
        jButton_AbrirArchivo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8/abrirArchivo.png"))); // NOI18N
        ...
        jToggleButton_Reproducir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons8/play.png"))); // NOI18N
    ...
    private void AbrirArchivoBL(){
        ...
        if(seleccionar.showDialog(null, "Abrir")== JFileChooser.APPROVE_OPTION){
            ...
            if(archivo.getName().endsWith("bl")){
                ...
                tabla = new BannerLeds(filas,columnas, encendido, apagado);
                tabla.setMatrix(matriz);
                jTextPane_Pantalla.setText(tabla.getText());
                archivoAbierto = true;
                
                frameParent.setTitle("BannerLed Player - " + archivo.getName());
            }else{
        ...
        if("".equals(instruccion)){JOptionPane.showMessageDialog(null, "Este archivo no cuenta con animaciones disponibles. Abra uno e intentelo otra vez.","ARCHIVO SIN ANIMACIONES", 0);}
            ...
            if(archivoAbierto){
                if(jToggleButton_Reproducir.isSelected()){
                    jToggleButton_Reproducir.setIcon(new ImageIcon(getClass().getResource("/icons8/pause.png")));
                    //
                    graficador = new LedScreenPlotter(filas, columnas, jTextPane_Pantalla, instruccion, encendido, apagado, texto);
                }else{
                    jToggleButton_Reproducir.setIcon(new ImageIcon(getClass().getResource("/icons8/play.png")));
                    graficador.stopFile();
                }
            }else{
                JOptionPane.showMessageDialog(null, "Para iniciar la animación del archivo es necesario abrirlo antes.","NO SE HA HABIERTO NINGÚN ARCHIVO", 0);
            }
